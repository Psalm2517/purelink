...
def register_commands(tree):
    ...
    async def purelink_info(interaction: discord.Interaction):
        ...
        embed.add_field(name="Source Code", value="[GitHub Repository](https://github.com/psalm2517/purelink-bot)", inline=False)
        embed.add_field(name="Bugs, Issues, & Feedback", value="[GitHub Issues Page](https://github.com/psalm2517/purelink-bot/issues)", inline=False)
